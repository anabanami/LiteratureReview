...
% \\\\PT NORMALISATION\\\\ its relation to incompleteness.... not positive definite
...
% Since we are dealing with two-level systems, it is useful to use the Bloch sphere to visualise the geometry of this system. 
% \begin{Figure}
% \centering
% \includegraphics[width=\linewidth]{Bloch_spheres.png}
% \captionof{figure}{}
% \label{fig:bloch}
% \end{Figure}
